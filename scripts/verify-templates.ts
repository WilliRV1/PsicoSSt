...
async function main() {
    ...
    const pairs: [string, string][] = [["individual.typ","individual-a"],["individual.typ","individual-extra"],["individual.typ","individual-stress"],["individual.typ","individual-invalido"],["individual.typ","individual-importado"],["sociodemographic.typ","sociodemographic"],["collective.typ","collective-executive"],["collective.typ","collective-technical"],["diagnostic.typ","diagnostic-full"],["diagnostic.typ","diagnostic-small"],["intervention.typ","intervention"],["sve.typ","sve"]];
    let bad = 0;
    ...
    console.log(bad ? `${bad} fallan` : "12/12 compilan"); process.exit(bad ? 1 : 0);
}
main();
