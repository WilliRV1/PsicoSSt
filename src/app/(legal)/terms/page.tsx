    ...
    return (
        <article className="prose prose-zinc dark:prose-invert max-w-none">
            ...
            <ul>
                ...
                <li>Los creditos se acreditan al confirmarse el pago. Los medios que no son inmediatos —PSE y pago en efectivo— pueden tardar desde unos minutos hasta tres (3) dias habiles en reflejarse.</li>
            </ul>
