    ...
    return (
        <article className="prose prose-zinc dark:prose-invert max-w-none">
            ...
            <ul>
                ...
                <li><strong>Mercado Pago (Mercado Libre Colombia Ltda.):</strong> Para el procesamiento de pagos. Los datos financieros —numero de tarjeta y codigo de seguridad— son capturados y tratados directamente por Mercado Pago conforme a sus politicas de seguridad PCI-DSS. PsicoSST no recibe, no procesa y no almacena esos datos en ningun momento: unicamente conserva el identificador de la transaccion, el medio de pago utilizado y el monto, para efectos contables y de soporte.</li>
