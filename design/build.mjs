...
export const MANIFEST = [
  // ── Fundamentos ────────────────────────────────────────────────────
  ['Fundamentos',   'fundamentos.fundamentos', 'sistema',  1440, 2420],

  // ── Operación ──────────────────────────────────────────────────────
  ['Main',             'panel.panel',                        'operacion', 1440, 900],
  ['Empresas',         'operacion.empresas',                 'operacion', 1440, 900],
  ['EmpresaDetalle',   'operacion.empresaDetalle',           'operacion', 1440, 1000],
  ...
  ['Invitar',          'evaluaciones.invitar',               'operacion', 1440, 1000],
  ['Digitacion',       'evaluaciones.digitacion',            'operacion', 1440, 920],
  ['CargaMasiva',      'evaluaciones.cargaMasiva',           'operacion', 1440, 1060],
  ['ImportarTrabajadores','evaluaciones.importarTrabajadores','operacion', 1440, 900],

  // ── Informes ───────────────────────────────────────────────────────
  ['Informes',         'informes.informes',                  'informes',  1440, 900],
  ['InformeIndividual','informes.informeIndividual',         'informes',  1440, 2060],
  ['FirmarInforme',    'informes.firmar',                    'informes',  1440, 900],
  ['Diagnostico',      'colectivos.informeDiagnostico',      'informes',  1440, 1860],
  ...
  ['AsistenteIA',      'analisis.asistenteIA',      'analisis', 1440, 1000],

  // ── Cuenta y sistema ───────────────────────────────────────────────
  ['Creditos',         'cuenta.creditos',           'cuenta',   1440, 980],
  ['Planes',           'cuenta.planes',             'cuenta',   1440, 1050],
  ['Equipo',           'cuenta.equipo',             'cuenta',   1440, 1050],
  ['Configuracion',    'cuenta.configuracion',      'cuenta',   1440, 1500],
  ['GuiaRapida',       'cuenta.tutorial',           'cuenta',   1440, 1080],

  // ── Administración ─────────────────────────────────────────────────
  ['PanelAdmin',       'admin.panelAdmin',          'admin',    1440, 1020],
  ...
  ['Terminos',         'publico.terminos',          'publico',  1440, 1280],
  ['Privacidad',       'publico.privacidad',        'publico',  1440, 1280],
...
for (const [pagina, lista] of porPagina) {
  ...
  for (const a of lista) {
    ...
    artboards.push({ file: `${a.nombre}.dc.html`, x, y, w: a.w, h: a.h, page: pagina });
    x += a.w + GAP_X;
